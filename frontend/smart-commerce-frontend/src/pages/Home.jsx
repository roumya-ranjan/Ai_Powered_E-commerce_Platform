...
function Home() {
    ...
    const buyNow = (product) => {
        ...
        if (!quantity || isNaN(quantity) || Number(quantity) < 1) return;
    ...
    return (
        <div style={{ background: "#f1f3f6", minHeight: "100vh", fontFamily: "sans-serif" }}>
            ...
            <div style={{ background: "#fff", borderBottom: "1px solid #e0e0e0", display: "flex", padding: "0 8px", overflowX: "auto" }}>
                <div
                    onClick={() => setSearch("")}
                    style={{ padding: "12px 16px", fontSize: 12, fontWeight: 500, color: "#2874f0", cursor: "pointer", whiteSpace: "nowrap", borderBottom: "2px solid #2874f0" }}
                >
                    All
                </div>
                {categories.map((cat) => (
                    <div
                        ...
                        style={{ padding: "12px 16px", fontSize: 12, fontWeight: 500, color: "#212121", cursor: "pointer", whiteSpace: "nowrap", borderBottom: "2px solid transparent" }}
                    >
                        {cat}
                    </div>
                ))}
            ...
            <div style={{ display: "flex", gap: 12, padding: 12 }}>
                ...
                <div style={{ width: 200, flexShrink: 0, background: "#fff", border: "0.5px solid #e0e0e0", padding: 16, borderRadius: 2, height: "fit-content" }}>
                    <h4 style={{ fontSize: 13, fontWeight: 600, marginBottom: 12, paddingBottom: 8, borderBottom: "1px solid #f0f0f0" }}>
                        Filters
                    </h4>
                    ...
                    <h4 style={{ fontSize: 13, fontWeight: 600, margin: "16px 0 8px", paddingBottom: 8, borderBottom: "1px solid #f0f0f0" }}>
                        Rating
                    </h4>
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ background: "#ff9f00", borderRadius: 4, padding: "10px 16px", marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <span style={{ background: "#fff", color: "#ff9f00", borderRadius: 2, padding: "2px 10px", fontSize: 11, fontWeight: 600 }}>
                    ...
                    {loading ? (
                        ...
                        <div style={{
                            ...
                            {filtered.map((product) => (
                                <div
                                    key={product.id}
                                    style={{ background: "#fff", padding: 14, cursor: "pointer", position: "relative" }}
                                ...
                                >
                                    ...
                                    <div
                                        style={{ fontSize: 13, fontWeight: 500, color: "#212121", marginBottom: 6, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
                                        title={product.name}
                                    >
                                        {product.name}
                                    </div>
                                    ...
                                    {product.stockQuantity <= 5 && (
                                        <div style={{ fontSize: 10, color: "#e53935", marginBottom: 4 }}>
